    ...
    expect(project).toMatchInlineSnapshot(`
      {
        ...
        "targets": {
          ...
          "copy-workspace-modules": {
            ...
            "outputs": [
              "{workspaceRoot}/dist/my-elysia-app/workspace_modules",
            ],
          },
          "prune": {
            "dependsOn": [
          ...
          "prune-lockfile": {
            ...
            "outputs": [
              "{workspaceRoot}/dist/my-elysia-app/package.json",
              "{workspaceRoot}/dist/my-elysia-app/package-lock.json",
            ],
          },
          "serve": {
            "configurations": {
              "development": {
                "buildTarget": "my-elysia-app:build:development",
              },
              "production": {
                "buildTarget": "my-elysia-app:build:production",
              },
            },
            "continuous": true,
            ...
            "executor": "@nx/js:node",
            "options": {
              "buildTarget": "my-elysia-app:build",
